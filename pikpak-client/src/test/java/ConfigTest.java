...
public class ConfigTest {
    @Test
    void dataParent() {
        var config = new Config(null, Map.of(
        ...
        assertThat(defaultData).isEqualTo(config.data().parent().get())
            .isEqualTo(config.users().get("xxx").data().parent().get().parent().get());
    }
    ...
    void dataExtract() {
        ...
        assertThat(defaultData.httpReferer())
            ...
            .isEqualTo(config.users().get("xxx").data().extract(Config.Data::httpReferer).get())
            .isNotEqualTo(config.users().get("yyy").data().extract(Config.Data::httpReferer).get());
    }
    ...
    void addUser() {
        ...
        var xxxUser = config.addUser(new Config.User("xxx", null, null, null))
            .user("xxx");
