...
public sealed interface Multipart {
    ...
    final class Impl implements Multipart {
        ...
        private Impl(String boundary, List<Part> parts) {
    ...
    class Builder implements lost.pikpak.client.util.Builder<Multipart> {
        ...
        public Builder textPart(String name, String contentType, BodyPublisher body) {
            var part = Part.builder(name).contentType(contentType).body(body).build();
            this.parts.add(part);
            return this;
        }

        public Builder filePart(String name, String filename, String contentType, BodyPublisher body) {
