...
public record FileDetailsResult(
    ...
    @Json(naming = Json.Naming.LowerUnderscore)
    public record Links(@Json.Property("application/octet-stream") OctetStream octetStream) {}

    @Json(naming = Json.Naming.LowerUnderscore)
    public record OctetStream(String url, String token, OffsetDateTime expire, String type) {}
    ...
    @Json(naming = Json.Naming.LowerUnderscore)
    public record Link(String url, String token, OffsetDateTime expire, String type) {}
